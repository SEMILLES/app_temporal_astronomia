...
def alternative_operation(occurrence_id,proposal,decision,*,actor_context,reviewed_by=None,review_note=None):
    def operation(connection):
        ...
        if canonical=="existing":
            alternative_id=review_as_existing(connection,submission_id,decision.get("alternative_id"),concept_resolution=concept_resolution,relation_policy=decision.get("relation_policy","preserve"),relations_resolution=decision.get("relations_resolution"),morphology_resolution=decision.get("morphology_resolution"),reviewed_by=reviewed_by,review_note=review_note,collaborator_id=actor_context.get("collaborator_id"),access_role=actor_context.get("access_role"))
        elif canonical=="new":
